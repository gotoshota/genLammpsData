...
def write_lammps_data(chains, srd_particles, box_size, filename="lmp.data"):
    """
    ...
    with open(filename, "w") as f:
        # ヘッダー情報の書き込み
        total_atoms = len(chains) * len(chains[0]) + n_srd
...
def main():
    ...
    write_lammps_data(chains, srd_particles, box_size, args.output)
